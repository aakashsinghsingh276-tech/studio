...
const DescribeImageOutputSchema = z.object({
  description: z.string().describe('A short, one-sentence description of the image.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a helpful assistant that describes images.

  Describe the following image in one short sentence.
